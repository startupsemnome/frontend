      ...
      <div className="App">
        <div>
          <form className="signupForm">
            <div>
              <ul>
                <label className="labelFields">Operador:</label>
                <br />
                <input
                  ...
                  onChange={e => this.setState({ operador: e.target.value })}
                />{" "}
                <br />
                <label className="labelFields">Nome da Empresa:</label>
                <br />
                <input
                  className="inputFields"
                  type="text"
                ...
                />
                <br />
                <label className="labelFields">Solicitante:</label>
                <br />
                <input
                  className="inputFields"
                  type="text"
                ...
                />
                <br />
                <label className="labelFields">Email:</label>
                <br />
                <input
                  className="inputFields"
                  type="text"
                ...
                />
                <br />
                <label className="labelFields">Telefone:</label>
                <br />
                <input
                  className="inputFields"
                  type="number"
